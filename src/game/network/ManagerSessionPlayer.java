 ...
 *
 */
public class ManagerSessionPlayer  extends CoreManagedObjects implements Serializable, ClientSessionListener{

	private static final long serialVersionUID = -6143746028573880418L;

	private static final Logger logger =
        Logger.getLogger(ManagerSessionPlayer.class.getName());
    ...
    public void enter(Room room, Player player) {
        logger.log(Level.INFO, "{0} enters {1} and {2}",
            new Object[] { this, room, player }
        );
